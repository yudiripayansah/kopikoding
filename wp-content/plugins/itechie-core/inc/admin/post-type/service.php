 ...
 * @since 1.0.0
*/
if (!class_exists('Itechie_Post_Type_Service')) {
    class Itechie_Post_Type_Service
    {
        ...
        function create_post_type()
        {
            ...
            $slug = $this->slug;
            $labels = array(
                'name'                  => esc_html_x('Services', 'Post Type General Name', 'itechie-core'),
                'singular_name'         => esc_html_x('Service', 'Post Type Singular Name', 'itechie-core'),
    ...
    Itechie_Post_Type_Service::getInstance();
} //endif 